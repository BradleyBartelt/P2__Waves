...
#### This week I found an HTML template for our homepage, and created the navbar for our website. I am currently linking our HTML templates to the navbar, but we only have 2 at the moment, so some of the links will not be active. I also set up a little enviornment for us to put our python object and class projects when those are complete, you can find it in the navbar. 
